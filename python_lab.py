...
representation_dict = {n:(a,b,c) for n in range(1000) for a in digits for b in digits for c in digits if (a*base**2) + (b * base**1) + (c*base**0) == n}
...
listdict2dict = { name: id2salary[eid] for eid, name in enumerate(names) }
